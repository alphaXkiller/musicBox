...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login, React, br, button, div, element, form, input, label, ref, render;

	React = __webpack_require__(1);

	render = __webpack_require__(158).render;

	ref = React.DOM, div = ref.div, button = ref.button, form = ref.form, label = ref.label, input = ref.input, br = ref.br;
	...
	Login = React.createClass({
	  ...
	  render: function() {
	    ...
	    return div(null, div(null, 'Log in'), button(null, 'Facebook Login'), div(null, 'or'), form(null, label(null, 'Email'), input({
	      type: 'text',
	      value: value,
	      onChange: this.handleChange
	    }), label(null, 'Password'), input({
	      type: 'password',
	      value: value
	    }), button({
	      type: 'submit'
